...
<video width="640" height="480" controls >
  <source src="videos/nojo.mp4" type="video/mp4">
...
<div class="d-flex justify-content-center">
<video width="640" height="480" controls >
  <source src="videos/surpresa1.mp4" type="video/mp4">
  Seu navegador não suporta o elemento <code>video</code>.
</video>
</div>
...
<div class="d-flex justify-content-center">
<video width="640" height="480" controls >
  <source src="videos/tristeza1.mp4" type="video/mp4">
  Seu navegador não suporta o elemento <code>video</code>.
</video>
</div>
...
<div class="d-flex justify-content-center">
<video width="640" height="480" controls >
  <source src="videos/tristeza2.mp4" type="video/mp4">
  Seu navegador não suporta o elemento <code>video</code>.
</video>
</div>
...
<div class="d-flex justify-content-center">
<video width="640" height="480" controls >
  <source src="videos/tristeza3.mp4" type="video/mp4">
  Seu navegador não suporta o elemento <code>video</code>.
</video>
</div>
...
<div class="d-flex justify-content-center">
<video width="640" height="480" controls >
  <source src="videos/tristeza4.mp4" type="video/mp4">
  Seu navegador não suporta o elemento <code>video</code>.
</video>
</div>
